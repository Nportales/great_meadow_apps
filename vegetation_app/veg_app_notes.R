...
#### copy of app prior to stacking of veg metric graphs ------------------------
...
#### copy of app prior to navigation bar---------------------------------------- 
...
#### version pre number of sites check-box-------------------------------------
#### Wetland Vegetation Dashboard ####
  ...
  div(class = "content-section",
      layout_sidebar(
        ...
        sidebar = sidebar(
          ...
          div(style = "padding: 10px; background-color: #e8f5e9; border-radius: 8px; border-left: 4px solid #2E7D32;",
              p(icon("info-circle"), "Solid lines show annual means ± SD across sites within each wetland. Dashed lines represent grand means across all years.", 
                style = "margin: 0; font-size: 0.9rem; color: #1b5e20;")),
